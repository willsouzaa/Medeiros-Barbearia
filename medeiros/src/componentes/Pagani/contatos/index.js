    ...
    <section className="contatos">
      <div className="contatos-shell">
        <div className="contatos-header">
          ...
          <p className="section-subtitle">Serviços rápidos, ambiente exclusivo e um time preparado para o seu melhor look.</p>
        </div>
        ...
        <div className="contato-actions">
          ...
          <a
            ...
            href="https://maps.google.com/?q=Rua+Jos%C3%A9+Bonif%C3%A1cio+de+Souza,+73+-+Pagani,+Palho%C3%A7a+-+SC"
            target="_blank"
            rel="noreferrer"
          >
            Ver rotas no mapa
        ...
        <div className="contatos-grid">
          <div className="contato-secao">
            ...
            <address className="info-contato">
              ...
              <p><strong>Endereço:</strong> Rua José Bonifácio de Souza, 73 - Pagani, Palhoça - SC</p>
            </address>
